exports.up = function(knex) {
  return knex.schema.createTable('hr_todos', function(table) {
    ...
    return knex.raw(`
      ALTER TABLE hr_todos 
      ADD CONSTRAINT hr_todos_progress_check 
...
exports.down = function(knex) {
  return knex.schema.raw('ALTER TABLE hr_todos DROP CONSTRAINT IF EXISTS hr_todos_progress_check')
    .then(function() {
      return knex.schema.dropTable('hr_todos');
    });
};
